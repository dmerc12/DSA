...
class Set:
    class BSTNode:
        def __init__(self, data, parent, left = None, right = None):
            self.data = data
            self.left: Set.BSTNode | None = left
            self.right: Set.BSTNode | None = right
            self.parent: Set.BSTNode | None = parent
    ...
    class BSTIterator:
        def __init__(self, node):
            self.node: Set.BSTNode | None = node
    ...
    def remove_node(self, node_to_remove: BSTNode | None):
